...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO Orders (Id_order, Id_pelanggan, Tanggal_order) VALUES ('$id_order', '$id_pelanggan', '$tanggal_order')";
...
<body>
    ...
    <form method="post">
        ...
        Tanggal_order: <input type="text" name="Tanggal_order" required><br>
